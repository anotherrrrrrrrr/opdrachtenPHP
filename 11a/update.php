<?php
    ...
    if(isset($_POST['btn_wzg'])){
        ...
        if(updatebrouw($_POST) == true){
            echo "<script>alert('brouw is gewijzigd')</script>";
        } else {
            echo '<script>alert("brouw is NIET gewijzigd")</script>';
        }
    }
...
<body>
  ...
  <form method="post">
    ...
    <input type="hidden" id="brouwcode" name="id" required value="<?php echo $row['brouwcode']; ?>"><br>
